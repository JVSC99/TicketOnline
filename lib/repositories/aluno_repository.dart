...
class AlunoRepository {
  static List<Aluno> lista = [
    Aluno(
        ...
        ra: '123',
        senha: '1234',
        carteira: Carteira(id: 'João_123', saldo: 1),
        historico: [
          Historico(data: '9/03/2022', refeicao: 'Jantar'),
          Historico(data: '9/03/2022', refeicao: 'Almoço'),
    ...
    Aluno(
        ...
        ra: '234567',
        senha: '1234',
        carteira: Carteira(id: 'Alysson_123', saldo: 100),
        historico: [
          Historico(data: '12/03/2022', refeicao: 'Jantar'),
          Historico(data: '12/03/2022', refeicao: 'Almoço'),
          Historico(data: '11/03/2022', refeicao: 'Jantar'),
